...
export const SEED_USERS: MockUser[] = [
  {
    id: 'usr-ana',
    name: 'Ana Ribeiro',
    displayName: 'anaribeiro',
    email: 'ana@kurio.test',
    password: 'kurio2026',
    avatarUrl: null,
    bio: 'Coleciono retratos generativos e apoio artistas emergentes.',
    website: 'https://ana.kurio.test',
    location: 'Recife, BR',
  ...
  },
  {
    id: 'usr-bruno',
    name: 'Bruno Tavares',
    displayName: 'btavares',
    email: 'bruno@kurio.test',
    password: 'kurio2026',
    avatarUrl: null,
    bio: 'Curador de coleções 3D e experimentos sonoros on-chain.',
    website: '',
    location: 'Lisboa, PT',
