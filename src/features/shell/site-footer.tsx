...
export function SiteFooter() {
  ...
  return (
    <footer className="mt-24 hidden md:block">
      {/* No layout o rodapé não é uma faixa de ponta a ponta: é um cartão
          centralizado, da mesma largura do conteúdo, com as três faixas
          (destaques, contato e links) empilhadas dentro dele. */}
      <div className="mx-auto max-w-page px-4 sm:px-8">
        <div className="overflow-hidden rounded-md border border-line">
          <div className="grid gap-8 bg-card/60 p-6 lg:grid-cols-[1fr_1fr_1fr_minmax(0,1.1fr)] lg:p-8">
          ...
          <div className="border-y border-line bg-primary/10">
            <div className="flex flex-wrap items-center gap-x-10 gap-y-3 px-6 py-5 text-xs lg:px-8">
          ...
          <div className="grid gap-10 px-6 py-12 md:grid-cols-2 lg:grid-cols-4 lg:px-8">
